...
<Box>
  User stories describe what may be built in the software project. User stories
...
```gherkin
    Feature: Achieve a specific goal
...
<Box>
  ![story mapping – example](/img/storymapping.svg)
</Box>
