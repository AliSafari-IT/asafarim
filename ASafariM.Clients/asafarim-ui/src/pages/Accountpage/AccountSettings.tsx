...
const AccountSettings: React.FC = () => {
    ...
    const handleUpdatePassword = async () => {
        console.log('Updating password...', authenticatedUser, currentPassword, newPassword);
        setLoading(true);
        try {
        ...
        <Layout
            header={
                <div className="bg-info/5 p-6 text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Manage your preferences and security settings</p>
                </div>
            }
        >
            <div className="max-w-4xl mx-auto px-4 py-8">
                <Suspense fallback={<LoadingSpinner />}>
                    ...
                    <TabPane tabs={tabs} defaultActiveKey="email" onTabChange={handleTabChange} />
                </Suspense>
            </div>
        </Layout>
    );
