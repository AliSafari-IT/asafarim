...
namespace ASafariM.Application.Utils
{
    public class CurrentUserService : ICurrentUserService
    {
        ...
        public Guid? GetCurrentUserId()
        {
            ...
            {
                Log.Warning("CurrentUserService:: User is not authenticated. Headers: {@Headers}", 
                    context.Request?.Headers?.Where(h => h.Key.StartsWith("Authorization"))
            ...
            {
                Log.Warning("CurrentUserService:: NameIdentifier claim not found. Available claims: {@Claims}", 
            ...
            {
                Log.Warning("CurrentUserService:: Failed to parse user ID '{UserId}' as GUID", userIdClaim);
                return null;
            }
