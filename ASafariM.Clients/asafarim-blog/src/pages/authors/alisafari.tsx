...
// Sample blog posts - these would normally be fetched from the blog data
const blogPosts = [
  {
    ...
    url: '/blog/2025/04/08/critique-issues-windsurf'
  },
  {
    ...
    url: '/blog/2025/04/01/creating-angular-portfolio-builder'
  },
  {
    ...
    url: '/blog/2025/03/21/welcome-to-asafarim-blog'
  },
  {
    ...
    url: '/blog/2023/05/12/lab-automation-benefits'
  },
  {
    id: 'start-post',
    title: 'Start Post',
    ...
    url: '/blog/2021/06/16/start-post'
  }
];

export default function AliSafariProfile(): JSX.Element {
  const {siteConfig} = useDocusaurusContext();
  
  // Get author data from our utility
  const author = getAuthor('alisafari');
      ...
      <main className="container margin-vert--lg">
        <div className={styles.authorProfileContainer}>
          ...
          <div className={styles.authorInfoPanel}>
            ...
            <div className={styles.authorDetail}>
              <ContactIcon /> <a href={author.contact}>Contact Me</a>
            </div>
