    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div className="relative h-[400px]">
          {/* Optional connecting lines for visual effect - placed first to be underneath */}
          <div className="absolute top-[200px] left-0 right-0 h-[1px] bg-gray-200 dark:bg-gray-700 z-0"></div>
          <div className="absolute top-0 bottom-0 left-[50%] w-[1px] bg-gray-200 dark:bg-gray-700 z-0"></div>
          
          {/* North - Email Contact */}
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-64 z-10">
          ...
          {/* East - LinkedIn Contact */}
          <div className="absolute top-1/2 right-0 transform -translate-y-1/2 w-64 z-10">
            <div className="flex flex-col items-center">
          ...
          {/* West - GitHub Contact */}
          <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-64 z-10">
            <div className="flex flex-col items-center">
          ...
          {/* Center element - optional decorative element */}
