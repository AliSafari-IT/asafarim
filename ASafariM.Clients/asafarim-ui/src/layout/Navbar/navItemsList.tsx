...
const mdChapters: INavItem[] = [
  {
    ...
    to: "#",
    description:
      "Learn the basics of Tailwind CSS and how it simplifies styling.",
    icon: <IconTeaching />,
    ...
    subMenu: [
      {
        ...
        to: "/md/learning/tailwind/intro",
        icon: <IconTeaching />,
      },
      {
        id: "install-tailwind",
        title: "Installing Tailwind in React",
  ...
  },
  {
    ...
    to: "#",
    description:
      "Learn how to set up Tailwind CSS with React and make the most of its features.",
    icon: <IconTeaching />,
    ...
    subMenu: [
      {
        ...
        title: "Using Tailwind with Create React App",
        to: "/md/learning/react/create-react-app",
        icon: <IconTeaching />,
      },
      {
        id: "vite-react",
    ...
    subMenu: [
      {
        ...
        to: "/md/learning/tailwind/grid",
        icon: <IconTeaching />,
      },
      {
        id: "breakpoints",
        name: "breakpoints",
        title: "Using Tailwind Breakpoints",
        to: "/md/learning/tailwind/breakpoints",
        icon: <IconTeaching />,
      },
      {
        id: "flexbox-layout",
        name: "flexbox-layout",
        title: "Building with Flexbox",
        to: "/md/learning/tailwind/flexbox",
        icon: <IconTeaching />,
      },
    ],
  },
  {
    ...
    to: "#",
    description:
      "How to create reusable components in React with Tailwind CSS.",
    icon: <IconTeaching />,
    ...
    topics: [
      {
        ...
        to: "/md/learning/tailwind-vs-css",
        icon: <IconTeaching />,
        description: undefined,
        name: "tailwind-vs-css",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        id: "best-practices",
        title: "Best Practices in Tailwind",
        to: "/md/learning/tailwind-best-practices",
        icon: <IconTeaching />,
        description: undefined,
        name: "best-practices",
        createdAt: new Date(),
...
const dashboard: IMenuItem = {
  ...
  subMenu: [
    ...
    {
      id: "asafarim-current-projects",
      title: "Current Projects",
      className: "",
      description: "",
      label: "Current Projects Demos",
      style: {},
      isForNavbar: true,
      name: "asafarim-current-projects",
      icon: <IconProject />,
      subMenu: [
        {
          id: "igs-pharma",
        ...
        },
        {
          id: "asafarim-cli",
          name: "asafarim-cli",
          title: "CLI (Only for Admins )",
          className: "",
          description: "",
          label: "ASafariM CLI (Loggedin Admins Only)",
          style: {},
          isForNavbar: true,
          to: "//asafarim.com/cli/",
          target: "_blank",
