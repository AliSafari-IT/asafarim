...
interface LoadingProps {
  ...
  message?: string; // Optional message to display below the loading icon
}

const Loading: React.FC<LoadingProps> = ({ size = 40, color = "#0056b3", isMobile = false, isSidebarOpen = false, message = "Loading..." }) => {
