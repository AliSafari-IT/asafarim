...
<Figure caption="Nx workspace created">
    <img src="/dist/client-docs/img/svgs/nx-project-graph.svg" alt="Nx workspace created" />
</Figure>

## How to use Nx?

We can use Nx by creating a new workspace, creating a new app, creating a new library, and creating a new component.
