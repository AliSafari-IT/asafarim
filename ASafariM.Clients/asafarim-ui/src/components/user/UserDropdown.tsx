...
const UserDropdown: React.FC<IUserDropdownProps> = ({  themeToggler, mobileView }) => {
  ...
  return (authenticatedUser &&
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span className="text-sm font-medium text-[var(--text-warning)]">{authenticatedUser.firstName} {authenticatedUser.lastName}</span>
        <svg
